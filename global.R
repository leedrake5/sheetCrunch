...
Pu.lines <- data.frame(lines$Ka1[93], lines$Ka2[93], lines$Kb1[93], lines$Kb2[93], lines$Kb3[93], lines$La1[93], lines$La2[93], lines$Lb1[93], lines$Lb2[93], lines$Lb3[93], lines$Lb4[93], lines$Lg1[93], lines$Lg2[93], lines$Lg3[93], lines$Ll[93])
...
spectra.light.fn <- function(data) {
    ...
    spectra.lines <- Reduce(function(x, y) merge(x, y, all=TRUE), list(Na.Ka.ag, Na.Kb.ag, Mg.Ka.ag, Mg.Kb.ag, Al.Ka.ag, Al.Kb.ag, Si.Ka.ag, Si.Kb.ag, P.Ka.ag, P.Kb.ag, S.Ka.ag, S.Kb.ag, Cl.Ka.ag, Cl.Kb.ag, Ar.Ka.ag, Ar.Kb.ag, K.Ka.ag, K.Kb.ag, Ca.Ka.ag, Ca.Kb.ag, Sc.Ka.ag, Sc.Kb.ag, Rh.La.ag))
