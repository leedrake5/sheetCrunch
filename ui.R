...
# Element selector using element_choices from global.R
element <- selectInput("element", "Element:", element_choices, selected="Fe.table"),
...
# Element selector using element_choices from global.R
selectInput('elementfingerprint', "Element:", element_choices, selected="Fe.table")
